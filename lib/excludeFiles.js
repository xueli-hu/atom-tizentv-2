    ...
    return {
        handleCommand:function() {
            ...
            if (null == selectedFiles || '' == selectedFiles) {
                let msg = 'No item is selected, please select your excluded file!';
                console.info(msg);
            ...
            let excludeFiles = atom.config.get('atom-tizentv-2.tizentv.excludeFiles');
            ...
            atom.config.set('atom-tizentv-2.tizentv.excludeFiles', excludeFiles);
