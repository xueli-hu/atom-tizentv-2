    ...
    var launchSimulatorApp = function (fileUrl) {
        ...
        if (simulatorSettingPath) {
            ...
            if (fs.existsSync(simulatorSettingPath)) {
                ...
                var executableNotFound = 'Cannot find the simulator executable program, please check your setting: Packages > Setting view > Open > Packages > search [atom-tizentv] > Settings';
        ...
        try {
            ...
            var commandFailMsg = 'Can not execute the command, please check your setting: Packages > Setting view > Open > Packages > search [atom-tizentv] > Settings';
