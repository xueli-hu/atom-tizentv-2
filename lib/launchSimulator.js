...
var launchSimulator = (function() {
    ...
    var launchSimulatorApp = function (fileUrl) {
        ...
        var simulatorSettingPath = atom.config.get('atom-tizentv-2.tizentv.simulatorLocation');
        logger.info('simulator path is ' + simulatorSettingPath);

		var sdkInstallPath = atom.config.get('atom-tizentv-2.tizentv.tizenStudioLocation');
        ...
        if (simulatorSettingPath) {
            ...
            if (fs.existsSync(simulatorSettingPath)) {
                ...
                var executableNotFound = 'Cannot find the simulator executable program, please check your setting: Packages > Setting view > Open > Packages > search [atom-tizentv-2] > Settings';
        ...
        try {
            ...
            var commandFailMsg = 'Can not execute the command, please check your setting: Packages > Setting view > Open > Packages > search [atom-tizentv-2] > Settings';
