...
var buildPackage = (function() {
	...
	return {
		...
		handleCommand:async function() {
			...
			{
				var noWorkspace = 'No project in workspace, please check and select your project!';
			...
			try {
				if (workspacePath) {
					...
					newApp.init();
					await newApp.buildWidget(profilePath, atom.config.get('atom-tizentv-2.tizentv.excludeFiles'));
