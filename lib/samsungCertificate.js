var samsungCertificate = (function() {
    ...
    const authorCaPath = common.extensionCertPath + path.sep + 'res' + path.sep + 'ca' + path.sep + 'vd_tizen_dev_author_ca.cer';
    const partnerCaPath = common.extensionCertPath + path.sep + 'res' + path.sep + 'ca' + path.sep + 'vd_tizen_dev_partner2.crt';
    const publicCaPath = common.extensionCertPath + path.sep + 'res' + path.sep + 'ca' + path.sep + 'vd_tizen_dev_public2.crt';
    ...
    return {
        handleCommand:async function() {
            if (!fs.existsSync(authorCaPath) || !fs.existsSync(partnerCaPath) || !fs.existsSync(publicCaPath)) {
