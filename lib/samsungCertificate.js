var samsungCertificate = (function() {
        ...
        dialog.showMessageBox({
			...
			if (response == 0)
			{
                loginSamsungAccount(authorCreatePage).then((accessInfo) => {
                    ...
                    samsungCertMgr.ceateAuthorCert(profileName, authorInfo, accessInfo).then((message) => {
    ...
    var distributorGenerate = function(profileName, distributorInfo, distributorCert) {
        ...
        samsungCertMgr.ceateDistributorCert(profileName, distributorInfo, distributorCert.accessInfo).then((message) => {
