var tizenCertificate = (function(){
	...
	var developerCAPath =  path.resolve(certPath, 'data', 'tools', 'certificate-generator', 'certificates', 'developer');
	var developerCA = developerCAPath + path.sep + 'tizen-developer-ca.cer';
	var distributorCAPath = path.resolve(certPath, 'data', 'tools', 'certificate-generator', 'certificates', 'distributor');
	var distributorPublicCA = distributorCAPath + path.sep + 'sdk-public' + path.sep + 'tizen-distributor-ca.cer';
	var distributorPublicSigner = distributorCAPath + path.sep + 'sdk-public' + path.sep +  'tizen-distributor-signer.p12';
	var distributorPartnerCA = distributorCAPath + path.sep + 'sdk-partner' + path.sep + 'tizen-distributor-ca.cer';
	var distributorPartnerSigner = distributorCAPath + path.sep + 'sdk-public' + path.sep + 'tizen-distributor-signer.p12';
	...
	var certZipFile = certPath + path.sep + 'certificate-generator.zip';
